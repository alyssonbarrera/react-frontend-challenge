		...
		<main className="min-h-screen bg-background">
			<div className="mx-auto grid min-h-screen w-full grid-cols-1 lg:h-screen lg:min-h-0 lg:grid-cols-2 xl:grid-cols-[42%_58%]">
				<section className="flex h-full w-full flex-col px-6 py-8 md:px-10 md:py-12 lg:px-12 lg:py-14">
					...
					<div className="flex flex-1 items-center py-8 md:items-center md:py-12 md:flex-1 lg:py-0">
						<div className="mx-auto w-full max-w-110 space-y-8 md:max-w-120 xl:max-w-130">
							<div className="inline-flex items-center gap-2 rounded-full bg-accent-cyan-soft px-3 py-1.5 text-xs text-accent-cyan">
								<div className="size-1.5 rounded-full bg-accent-cyan" />
				...
				<section className="relative hidden h-full overflow-hidden lg:block">
					...
					<div className="absolute inset-0 bg-[radial-gradient(circle_at_52%_18%,rgba(244,184,96,0.36),transparent_28%)]" />

					<div className="relative flex h-full flex-col justify-end gap-6 p-14">
						<div className="inline-flex w-fit items-center gap-2 rounded-full border border-white/10 bg-black/40 px-3 py-1.5 text-[11px] text-secondary backdrop-blur-xl">
							<div className="size-1.5 rounded-full bg-accent-amber" />
							This week's spotlight
						</div>

						<h2 className="max-w-140 whitespace-pre-line font-heading text-6xl leading-none font-bold tracking-[-0.04em] text-text-primary">
						...
						<p className="max-w-130 text-sm leading-relaxed text-secondary italic">
