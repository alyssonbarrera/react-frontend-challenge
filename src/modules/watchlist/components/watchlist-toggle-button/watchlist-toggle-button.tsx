...
const watchlistToggleButtonVariants = cva(
	"inline-flex items-center justify-center transition outline-none focus-visible:ring-2 focus-visible:ring-ring/40 disabled:pointer-events-none disabled:opacity-50",
	{
		variants: {
			variant: {
